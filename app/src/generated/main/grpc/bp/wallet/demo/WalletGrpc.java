...
public final class WalletGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<bp.wallet.demo.WalletRequest,
      bp.wallet.demo.WalletResponse> getWithdrawSMethod;
  ...
  public static io.grpc.MethodDescriptor<bp.wallet.demo.WalletRequest,
      bp.wallet.demo.WalletResponse> getWithdrawSMethod() {
    io.grpc.MethodDescriptor<bp.wallet.demo.WalletRequest, bp.wallet.demo.WalletResponse> getWithdrawSMethod;
    if ((getWithdrawSMethod = WalletGrpc.getWithdrawSMethod) == null) {
      synchronized (WalletGrpc.class) {
        if ((getWithdrawSMethod = WalletGrpc.getWithdrawSMethod) == null) {
          WalletGrpc.getWithdrawSMethod = getWithdrawSMethod = 
              io.grpc.MethodDescriptor.<bp.wallet.demo.WalletRequest, bp.wallet.demo.WalletResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "wallet.Wallet", "WithdrawS"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bp.wallet.demo.WalletRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bp.wallet.demo.WalletResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new WalletMethodDescriptorSupplier("WithdrawS"))
                  .build();
          }
        }
     }
  ...
  public static abstract class WalletImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<bp.wallet.demo.WalletRequest> withdrawS(
        io.grpc.stub.StreamObserver<bp.wallet.demo.WalletResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getWithdrawSMethod(), responseObserver);
    }
  ...
  public static final class WalletStub extends io.grpc.stub.AbstractStub<WalletStub> {
    ...
    public io.grpc.stub.StreamObserver<bp.wallet.demo.WalletRequest> withdrawS(
      ...
      return asyncClientStreamingCall(
          getChannel().newCall(getWithdrawSMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_WITHDRAW_S = 3;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_WITHDRAW_S:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.withdrawS(
              (io.grpc.stub.StreamObserver<bp.wallet.demo.WalletResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
